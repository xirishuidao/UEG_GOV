    ...
    public healthy getOneById(long cid) {
        ...
        if(ob1==null){
            ...
            for (int i = 0; i < ob1.length; i++) {
                switch (i) {
                    case 0:
                        healthy1.setCid((Long) ob1[i]);
                        break;
                    case 1:
                        healthy1.setCgender((String) ob1[i]);
                        break;
                    case 2:
                        healthy1.setCblood((String) ob1[i]);
                        break;
                    case 3:
                        healthy1.setCheight((Double) ob1[i]);
                        break;
                    case 4:
                        healthy1.setCveight((Double) ob1[i]);
                        break;
                    case 5:
                        healthy1.setCcode((int) ob1[i]);
                        break;
                    case 6:
                        healthy1.setChandicapped((int) ob1[i]);
                        break;
                    case 7:
                        healthy1.setCdisease1((String) ob1[i]);
                        break;
                    case 8:
                        healthy1.setCdisease2((String) ob1[i]);
                        break;
                }
            }
            return healthy1;
