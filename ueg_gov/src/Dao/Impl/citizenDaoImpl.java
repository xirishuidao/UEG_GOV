...
public class citizenDaoImpl  extends BaseDaoImpl implements citizenDao {
    ...
    public citizen getOneById(long cid) {
        ...
        for(int i=0;i<citizen1.length;i++){
            switch(i){
                case 0:c1.setCid((long)citizen1[0]);break;
                case 1:c1.setCname((String)citizen1[1]);break;
                case 2:c1.setCpwd((String)citizen1[2]);break;
                case 3:c1.setCquestion((String)citizen1[3]);break;
                case 4:c1.setCanswer((String)citizen1[4]);break;
            }
        }
        return c1;
    }
